				...
				<ul class="nav">
					...
					<li class="dropdown active" id="menu1">
						...
						<ul class="dropdown-menu active">
							...
							<li class="active"><a href="../pages/semifinal.php">Semifinal</a></li>
...
VALUES ('$partido', '$fecha', '$resultado', '$apostante', '$apuesta', '$cuota', '$ganancia','SEMI','$band_local', '$band_visit', '$comentario') ")){
	//$query="UPDATE EURO2012.partidos set apostante='$culo' where id=14;";
	//$query="UPDATE EURO2012.partidos set apostante='aa' where id=14;";
	//mysql_close($mycon);
